package com.zhangyw.utils.String;
...
public class StringUtil {
	private static final String FROMENCODE = "GBK";
	private static final String TOENCODE = "GBK";
	...
	public static int compare(String str1, String str2) {
		...
		String m_s2 = null;
		try {
			m_s1 = new String(str1.getBytes());
			m_s2 = new String(str2.getBytes());
		} catch (Exception e) {
	 ...
	 */
	public static  String getChineseBiginCharacter(String chinese,boolean isfirst,String charset) throws UnsupportedEncodingException{
