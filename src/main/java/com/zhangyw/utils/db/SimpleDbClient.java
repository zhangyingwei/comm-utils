...
public class SimpleDbClient {
    private Logger logger = Logger.getLogger(SimpleDbClient.class);
    ...
    public SimpleDbClient(String url, String username, String password) {
        this.url = url;
